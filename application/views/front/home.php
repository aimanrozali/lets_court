<div id="slides" class="carousel slide carousel-cus" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo base_url() . 'public/front/img/dash1.jpg'; ?>" alt="FriesBrgrImg">
        ...
        <div class="carousel-item">
            <img src="<?php echo base_url() . 'public/front/img/dash3.jpg'; ?>" alt="corn">
            <div class="carousel-caption text-right">
                <h1 class="display-2">LET'S COURT</h1>
                <h3>Book Azman Hashim's Court with us!</h3>
                <a href="<?php echo base_url() . 'court/index' ?>" class="btn btn-outline-light btn-lg">Book Now</a>
...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        ...
        <hr>
        <div class="col-12">
            <p class="lead">Tan Sri Azman Hashim, the founder and chairman of Ambank Group, donated RM10 million for the
                construction of the Azman Hashim Sports Arena which is located on the USM main campus here. The
                multi-purpose complex known as Azman Hashim Sports Arena has an area of 5,098 square meters. Various
                facilities in the arena will be built, namely 1 volleyball court, 2 futsal courts and 10 badminton
                courts. This is the second indoor Sports Complex after USM had a Badminton Sports Complex built in the
                80s.</p>
        </div>
    </div>
</div>
...
<form name="contact-form" action="<?php echo base_url() . 'home/sendFeedback'; ?>" id="myForm" method="POST">
    <div class="row">
        <div class="col-md-6">
            <div class="mb-2">
